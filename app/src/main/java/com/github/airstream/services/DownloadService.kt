package com.github.airstream.services
...
import com.github.airstream.AirstreamApp.Companion.DOWNLOAD_CHANNEL_NAME
import com.github.airstream.R
import com.github.airstream.api.MediaServiceRepository
import com.github.airstream.api.obj.PipedStream
...
import com.github.airstream.enums.NotificationId
import com.github.airstream.extensions.TAG
import com.github.airstream.extensions.formatAsFileSize
import com.github.airstream.extensions.parcelableExtra
import com.github.airstream.extensions.toLocalDate
import com.github.airstream.extensions.toastFromMainDispatcher
import com.github.airstream.extensions.toastFromMainThread
import com.github.airstream.helpers.DownloadHelper
import com.github.airstream.helpers.DownloadHelper.getNotificationId
...
import com.github.airstream.obj.DownloadStatus
import com.github.airstream.parcelable.DownloadData
import com.github.airstream.receivers.NotificationReceiver
import com.github.airstream.receivers.NotificationReceiver.Companion.ACTION_DOWNLOAD_PAUSE
import com.github.airstream.receivers.NotificationReceiver.Companion.ACTION_DOWNLOAD_RESUME
import com.github.airstream.receivers.NotificationReceiver.Companion.ACTION_DOWNLOAD_STOP
import com.github.airstream.repo.DownloadProgressResult
import com.github.airstream.repo.DownloadProvider
import com.github.airstream.repo.RawByteStreamDownloadProvider
import com.github.airstream.repo.SabrDownloadProvider
...
class DownloadService : LifecycleService() {
    ...
    companion object {
        ...
        const val ACTION_SERVICE_STARTED =
            "com.github.airstream.services.DownloadService.ACTION_SERVICE_STARTED"
        const val ACTION_SERVICE_STOPPED =
            "com.github.airstream.services.DownloadService.ACTION_SERVICE_STOPPED"
        const val ACTION_RESUME_ALL =
            "com.github.airstream.services.DownloadService.ACTION_RESUME_ALL"
