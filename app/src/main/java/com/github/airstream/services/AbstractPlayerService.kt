...
import com.github.airstream.extensions.updateParameters
...
import com.github.airstream.util.DefaultTrackSelectorWithAudioQualitySupport
import com.github.airstream.util.NowPlayingNotification
import com.github.airstream.util.PauseableTimer
...
abstract class AbstractPlayerService : MediaLibraryService(), MediaLibrarySession.Callback {
    ...
    private fun createPlayerAndMediaSession() {
        ...
        // prevent android from putting Airstream to sleep when locked
