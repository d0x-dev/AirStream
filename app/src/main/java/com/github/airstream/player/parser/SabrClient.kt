package com.github.airstream.player.parser
...
import com.github.airstream.player.manifest.Representation
...
class SabrClient private constructor(
    ...
    private val bandwidthEstimator = DefaultBandwidthMeter.getSingletonInstance(AirstreamApp.instance)
