...
import com.github.airstream.helpers.LocaleHelper.getDetectedCountry
...
object PreferenceHelper {
    ...
    private val MIGRATIONS = arrayOf(
        PreferenceMigration(0, 1) {
            AirstreamApp.instance.resources
        ...
        PreferenceMigration(2, 3) {
            // git log -p -- app/src/main/java/com/github/airstream/constants/PreferenceKeys.kt | rg "^-.*const val [A-Z_]+" | awk '{printf("%s,", $6);}' | sort | uniq
            listOf(
                "player_audio_format",
                "lbry_hls",
