...
import com.github.airstream.api.obj.ChapterSegment
...
import com.github.airstream.compat.PictureInPictureParamsCompat
import com.github.airstream.constants.IntentData
import com.github.airstream.databinding.FragmentPlayerBinding
import com.github.airstream.db.DatabaseHolder
import com.github.airstream.enums.FileType
import com.github.airstream.enums.PlayerCommand
import com.github.airstream.enums.PlayerEvent
...
import com.github.airstream.extensions.serializableExtra
...
import com.github.airstream.helpers.PlayerHelper.getCurrentSegment
...
import com.github.airstream.services.OfflinePlayerService
import com.github.airstream.services.OnlinePlayerService
...
import com.github.airstream.ui.dialogs.PlayOfflineDialog
import com.github.airstream.ui.dialogs.ShareDialog
import com.github.airstream.ui.extensions.animateDown
import com.github.airstream.ui.extensions.getSystemInsets
import com.github.airstream.ui.extensions.setOnBackPressed
...
import com.github.airstream.ui.listeners.SeekbarPreviewListener
import com.github.airstream.ui.models.ChaptersViewModel
import com.github.airstream.ui.models.CommentsViewModel
...
import com.github.airstream.util.OfflineTimeFrameReceiver
import com.github.airstream.util.OnlineTimeFrameReceiver
import com.github.airstream.util.PlayingQueue
import com.github.airstream.util.TextUtils
import com.github.airstream.util.TextUtils.toTimeInSeconds
...
class PlayerFragment : Fragment(R.layout.fragment_player), CustomPlayerCallback {
    ...
    private fun initializeOnClickActions() {
        ...
        binding.descriptionLayout.onDescriptionClicked = {
            if (this::streams.isInitialized) {
                updateMaxSheetHeight()
                com.github.airstream.ui.sheets.DescriptionSheet()
                    .apply {
                        arguments = androidx.core.os.bundleOf(
                            com.github.airstream.ui.sheets.DescriptionSheet.ARG_STREAMS to kotlinx.serialization.json.Json.encodeToString(com.github.airstream.api.obj.Streams.serializer(), streams)
                        )
                    }
                    .show(childFragmentManager, "DescriptionSheet")
            }
        }
    }
