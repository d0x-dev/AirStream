<div align="center">
  <img src="assets/banners/gh-banner.png" width="auto" height="auto" alt="Airstream">

[![GPL-v3](assets/widgets/license-widget.svg)](https://www.gnu.org/licenses/gpl-3.0.en.html)
</div><div align="center" style="width:100%; display:flex; justify-content:space-between;">

[![Matrix](assets/widgets/mat-widget.svg)](https://matrix.to/#/#Airstream:matrix.org)
[![Mastodon](assets/widgets/mast-widget.svg)](https://fosstodon.org/@airstream)
[![Lemmy](assets/widgets/lemmy-widget.svg)](https://feddit.rocks/c/airstream)
...
[<img src="assets/badges/fdrload.png" alt="Get it on F-Droid" width="30%">](https://f-droid.org/en/packages/com.github.airstream/)
[<img src="assets/badges/izzyload.png" alt="Get it on IzzyOnDroid" width="30%">](https://apt.izzysoft.de/fdroid/index/apk/com.github.airstream)<br/>
[<img src="assets/badges/ghload.png" alt="Get it on GitHub" width="30%">](https://github.com/libre-tube/Airstream/releases/latest)
...
<sub>[Default App Icon](https://github.com/libre-tube/Airstream/blob/master/app/src/main/res/mipmap-xxxhdpi/ic_launcher_round.png) by [XelXen](https://github.com/XelXen)</sub> <br>
<sub>[Boosted Bird](https://github.com/libre-tube/Airstream/blob/master/app/src/main/res/mipmap-xxxhdpi/ic_bird_round.png) by [Margot Albert-Heuzey](https://margotdesign.ovh)</sub>
...
* More screenshots can be found [here](https://github.com/libre-tube/Airstream/blob/master/SCREEN_SHOT.md)
...
<a href="https://hosted.weblate.org/projects/airstream/#languages">
<img src="https://hosted.weblate.org/widgets/airstream/-/287x66-grey.png" alt="Translation status" />
</a>
...
Airstream's main difference to NewPipe is that it has a much stronger focus on user experience. Airstream uses the modern [Material 3 Expressive](https://m3.material.io) design, supports external APIs such as SponsorBlock, ReturnYouTubeDislike, or DeArrow, and allows you to synchronize your user data across devices, e.g. via Piped. <!-- TODO: replace with Airstream sync server -->

While Airstream only supports content from YouTube, NewPipe also allows the use of other platforms like SoundCloud, PeerTube, Bandcamp and media.ccc.de.

Both, Airstream and NewPipe, are great clients for watching YouTube videos. There's no general answer about which one is better, just try them both and see which one fits you best.
...
Airstream aims to protect the privacy of its users. [Our Privacy Policy](/PRIVACY_POLICY.md) gives detailed information on which data the app stores in order to work, how it is being used, and how the project protects your personal information. It is recommended to read the privacy policy of Airstream as well as the privacy policy of the instance you have chosen inside the app.

## License
[![GNU GPLv3 Image](https://www.gnu.org/graphics/gplv3-127x51.png)](http://www.gnu.org/licenses/gpl-3.0.en.html)

Airstream is [Free Software](https://en.wikipedia.org/wiki/Free_software): You can use, study, share and modify it at your will. The app can be redistributed and/or modified under the terms of the
